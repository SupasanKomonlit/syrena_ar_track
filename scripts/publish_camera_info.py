...
class PublishCameraInfo:
    ...
    def __init__( self ):
        ...
        self.topic_publish = rospy.get_param( '~topic_camera_info'
            , "/" + self.camera_name + "/camera_info" )

        self.message = CameraInfo()

        self.publisher = rospy.Publisher( self.topic_publish , CameraInfo , queue_size = 10 )
